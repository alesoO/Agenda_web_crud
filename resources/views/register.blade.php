            ...
            <div class="formulario w-100 m-auto">
                ...
                <form action="/register" method="post">
                    ...
                    <div class="form-floating">
                        <input type="text" name="name" id="name" class="mt-4 rounded-0 rounded-top-3 form-control"
                            placeholder="Nome">
                        <label>Nome</label>
                    </div>
                    ...
                    <div class="form-floating">
                        <input type="password" name="password" id="password"
                            class="mb-4 rounded-0 rounded-bottom-3 form-control" placeholder="Confirmação da Senha">
                        <label>Senha</label>
                    </div>
